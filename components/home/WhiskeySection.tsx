...
const whiskeyProducts = products
  .filter((p: any) => p.category && p.category.toLowerCase() === 'whiskey')
  .map((p: any) => ({
    ...p,
...
const WhiskeySection = () => {
  ...
  const totalTabs = Math.ceil(whiskeyProducts.length / productsPerTab);
  ...
  const getCurrentTabProducts = () => {
    ...
    return whiskeyProducts.slice(startIndex, endIndex);
  };
    ...
    <section className="w-full py-8 px-4 bg-white">
      <div className="max-w-[fit] mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          >
            Elevate Your Taste With Our Finest Whiskey
          </h2>
        ...
        <div
          className="grid grid-cols-2 lg:grid-cols-4 gap-4 relative overflow-hidden min-h-[300px] md:min-h-[350px] lg:min-h-[430px]"
          // style={{ minHeight: 450 }}
        >
