...
export const products = [
  // Whiskey
  {
    ...
    badges: ["sale"],
    rating: 4.8,
    image: "/images/products/whiskey/Macallan-12-Year-Old.avif",
  ...
  // Beer
  {
    ...
    badges: ["new"],
    rating: 4.7,
    image: "/images/westvleteren-12.avif",
  ...
  // Spirits
  {
    ...
    badges: ["new"],
    rating: 4.8,
    image: "/images/products/hennessy-xo.avif",
    slug: "hennessy-xo",
    inStock: true,
    stockCount: 20,
    description:
  ...
  },
  {
    ...
    badges: ["new"],
    rating: 4.7,
    image: "/images/products/jasmine-dragon-pearl-tea.avif",
